...
<table class="form-table">
    ...
    <tr valign="top">
        ...
        <?php wr__e('Shortcode') ?></label> <code>[liveinternetcounter]</code><br/>
        <code>&lt;?php do_shortcode('[liveinternetcounter]') ?&gt;</code> &mdash; <i><?php wr__e('Use this code in your template') ?></i><br/>
        </td>
    </tr>
    <tr valign="top"><th scope="row"><?php wr__e('Page Title in Statistic') ?></th>
        <td>
        <label><input type="radio" name="wordefinery[page_title]" value="0" <?php checked(0, $this->store->page_title); ?> />
        <?php wr__e('Disable') ?></label><br/>
